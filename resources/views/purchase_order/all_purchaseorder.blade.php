...
@section('admin')
    ...
    "render": function(data, type, row) {
        // Pastikan properti data valid atau tampilkan string kosong
    ...
    "render": function(data, type, row) {
        if (type === 'display' && data.length > 6) {
            return data.substr(0, 6) + '...'; // Jika panjang 'mo' lebih dari 6 karakter, tampilkan hanya 6 karakter pertama ditambah '...'
        }
        return data;
    }
    ...
    data: "supplier_name",
    render: function(data, type, row) {
        // Jika data tidak ada, tampilkan string kosong
