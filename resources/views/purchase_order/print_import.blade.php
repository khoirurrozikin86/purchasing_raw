...
<table class="table detail-request table-detail-request" id="detail-request-table"
       style="font-size: {{ count($purchaseorder->detailorder) > 10 ? '6px' : '10px' }}">
    <thead>
        <tr>
            <th>No</th>
            <th>Code</th>
    ...
    <tbody>
        ...
        @foreach ($purchaseorder->detailorder as $detail)
            @php
                ...
                $itemGroups[$itemCode]['total_qty'] += $detail->qty;
            @endphp
        @endforeach
