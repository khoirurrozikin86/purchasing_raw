    ...
    <script>
        $(document).ready(function() {
            ...
            $('#bomForm').off('submit').on('submit', function(e) {
                ...
                submitButton.prop('disabled', true); // Disable tombol untuk mencegah klik ganda
                ...
                console.log('BOM Data before send:', bomData);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        submitButton.prop('disabled',
                            false); // Aktifkan kembali tombol setelah sukses
                    ...
                    error: function(error) {
                        ...
                        alert('Error saving BOM.');
                        submitButton.prop('disabled',
                            false); // Aktifkan kembali tombol setelah error
                    }
                });
            });
