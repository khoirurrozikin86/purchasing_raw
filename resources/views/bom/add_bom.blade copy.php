                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="container">
                                <h6 class="card-title text-center">BOM Management</h6>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm style"
                                                    id="style" name="style">
                                            ...
                                            <tbody>
                                                <tr class="detail-row">
                                                    ...
                                                    <td><input type="text" name="item_name[]"
                                                            class="item-name form-control" required>
                                                    </td>
                                                    ...
                                                    <td><input class="form-control" type="text" name="size[2XL][]"
                                                            placeholder="Consumption">
                                                    </td>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#bomForm').submit(function(e) {
                    ...
                    $('#bomTable tbody tr').each(function(index) {
                        const item = {
                        ...
                        $(this).find('input[name^="size"]').each(function() {
                            ...
                            item.sizes[sizeName] = consumption ? parseInt(consumption) : null;
                        });
                ...
                function clearInput() {
                    ...
                    <tr class="detail-row">
                        ...
                        <td><input class="form-control" type="text" name="size[2XL][]" placeholder="Consumption"></td>
